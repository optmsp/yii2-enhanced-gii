...
class Generator extends BaseGenerator
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [
                ["db", "nsModel", "tableName", "modelClass", "queryNs"],
                "filter",
                "filter" => "trim",
            ],
            ...
            [
                ["nsModel", "baseModelClass", "queryNs", "queryBaseClass"],
                "match",
                "pattern" => '/^[\w\\\\]+$/',
                "message" =>
            ...
            [
                ["queryBaseClass", "queryClass"],
                "validateClass",
                "params" => ["extends" => ActiveQuery::className()],
            ],
            [["db"], "validateDb"],
            [
                [
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            "generateAttributeHints" =>
                "This indicates whether the generator generate attribute hints on the extended models",
            ...
            "deletedBy" =>
                "This indicates whether the generator should generate Soft Delete feature for Model or not. " .
            ...
            "deletedByValue" =>
                "This will generate the <code>value</code> marker entry for Soft Delete feature for model " .
            ...
            "deletedByValueRestored" =>
                "This will generate the <code>value</code> marker for entry that is not deleted " .
            ...
            "deletedAt" =>
                "This give additional info for deleted row of Model. " .
            ...
            "deletedAtValue" =>
                "Enter this field with additional <code>value</code> to be saved. You could enter PHP function here. " .
            ...
            "deletedAtValueRestored" =>
                "This will generate the <code>value</code> information when restored. " .
            ...
            "generateBaseOnly" =>
                "This indicates whether the generator should generate extended model(where you write your code) or not. " .
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $queryClassName = $this->generateQuery
                ? $this->generateQueryClassName($modelClassName)
                : false;
            $tableSchema = $db->getTableSchema($tableName);
            $this->modelClass = "{$this->nsModel}\\{$modelClassName}";
            $this->tableSchema = $tableSchema;
            $this->isTree = !array_diff(
                self::getTreeColumns(),
            ...
            // model :
            $files[] = new CodeFile(
                Yii::getAlias("@" . str_replace("\\", "/", $this->nsModel)) .
                    "/base/" .
                    $modelClassName .
                    ".php",
    ...
    protected function isColumnAutoIncremental($table, $columns)
    {
        foreach ($columns as $column) {
            if (
                isset($table->columns[$column]) &&
                $table->columns[$column]->autoIncrement
            ) {
                return true;
            }
        }
    ...
    public function generateRules($table)
    {
        ...
        foreach ($table->columns as $column) {
            ...
            if (!$column->allowNull && $column->defaultValue === null) {
                if (
                    $this->isTree &&
                    in_array($column->name, ["lft", "rgt", "lvl"])
                ) {
                } else {
        ...
        try {
            ...
            if (!empty($this->optimisticLock)) {
                ...
                $rules[] =
                    "[['" .
                    $this->optimisticLock .
                    "'], 'mootensai\\components\\OptimisticLockValidator']";
            }
